# LIBRARY MEMORY ENGINE EXECUTION 07 — BUILD PROVENANCE-AWARE RANKING + BUILD DEDUPLICATION AND NEAR-DUPLICATE HANDLING + BUILD EXPLAINABLE MULTI-SIGNAL FUSION

## Execution Identity

- **Execution:** Library Memory Engine Execution 07
- **Roadmap tasks embedded:** 17, 18, 19
...
Deliver one coherent Library Memory Engine execution slice covering **Build provenance-aware ranking + Build deduplication and near-duplicate handling + Build explainable multi-signal fusion**. Each Child Loop must reach `YES`; then perform an integrated review and fresh final-state verification. The Engine must remain backend/terminal-first and game-independent.
...
# CHILD LOOP 1 — TASK 17: Build provenance-aware ranking
...
Implement **Task 17: Build provenance-aware ranking** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build provenance-aware ranking** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
Answer exactly: **HAVE WE ACHIEVED THE FINAL GOAL FOR TASK 17? — YES / PARTIALLY / NO**
...
# CHILD LOOP 2 — TASK 18: Build deduplication and near-duplicate handling
...
Implement **Task 18: Build deduplication and near-duplicate handling** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build deduplication and near-duplicate handling** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
Answer exactly: **HAVE WE ACHIEVED THE FINAL GOAL FOR TASK 18? — YES / PARTIALLY / NO**

Advance only on `YES` with fresh evidence. On an irreducible blocker, stop dependent work and preserve the safest truthful state.

---

# CHILD LOOP 3 — TASK 19: Build explainable multi-signal fusion
...
Implement **Task 19: Build explainable multi-signal fusion** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build explainable multi-signal fusion** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
Answer exactly: **HAVE WE ACHIEVED THE FINAL GOAL FOR TASK 19? — YES / PARTIALLY / NO**
