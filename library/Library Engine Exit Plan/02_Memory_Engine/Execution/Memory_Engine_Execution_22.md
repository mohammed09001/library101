# LIBRARY MEMORY ENGINE EXECUTION 22 — BUILD PROMPT-INJECTION AND UNTRUSTED-CONTENT BOUNDARIES + BUILD BACKUP, RESTORE, AND INTEGRITY CHECKS + INSTRUMENT MEMORY HEALTH AND RETRIEVAL QUALITY

## Execution Identity

- **Execution:** Library Memory Engine Execution 22
- **Roadmap tasks embedded:** 38, 39, 40
- **Roadmap phase:** PHASE VII — PRIVACY, RELIABILITY, AND OPERATIONS
...
- **Execution order:** Task 38 → Task 39 → Task 40
...
Deliver one coherent Library Memory Engine execution slice covering **Build prompt-injection and untrusted-content boundaries + Build backup, restore, and integrity checks + Instrument Memory health and retrieval quality**. Each Child Loop must reach `YES`; then perform an integrated review and fresh final-state verification. The Engine must remain backend/terminal-first and game-independent.
...
# CHILD LOOP 1 — TASK 38: Build prompt-injection and untrusted-content boundaries
...
Implement **Task 38: Build prompt-injection and untrusted-content boundaries** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build prompt-injection and untrusted-content boundaries** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
Answer exactly: **HAVE WE ACHIEVED THE FINAL GOAL FOR TASK 38? — YES / PARTIALLY / NO**
...
# CHILD LOOP 2 — TASK 39: Build backup, restore, and integrity checks
...
Implement **Task 39: Build backup, restore, and integrity checks** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build backup, restore, and integrity checks** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
Answer exactly: **HAVE WE ACHIEVED THE FINAL GOAL FOR TASK 39? — YES / PARTIALLY / NO**

Advance only on `YES` with fresh evidence. On an irreducible blocker, stop dependent work and preserve the safest truthful state.

---

# CHILD LOOP 3 — TASK 40: Instrument Memory health and retrieval quality
...
Implement **Task 40: Instrument Memory health and retrieval quality** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Instrument Memory health and retrieval quality** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
Answer exactly: **HAVE WE ACHIEVED THE FINAL GOAL FOR TASK 40? — YES / PARTIALLY / NO**
