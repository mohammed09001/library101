# LIBRARY REPOSITORY SEARCH ENGINE EXECUTION 08 — BUILD BOUNDED DOCUMENTATION INSPECTION + BUILD LEXICAL CODE SAMPLING WITH RIPGREP FOR LOCAL SNAPSHOTS + BUILD SYMBOL SAMPLING WITH UNIVERSAL CTAGS

## Execution Identity

- **Execution:** Library Repository Search Engine Execution 08
- **Roadmap tasks embedded:** 21, 22, 23
- **Roadmap phase:** PHASE IV — LIGHT REPOSITORY INSPECTION
...
Deliver one coherent Library Repository Search Engine execution slice covering **Build bounded documentation inspection + Build lexical code sampling with ripgrep for local snapshots + Build symbol sampling with Universal Ctags**. Each Child Loop must reach `YES`; then perform an integrated review and fresh final-state verification. The Engine must remain backend/terminal-first and game-independent.
...
- **Why this Execution cares:** Fast recursive lexical search respecting ignore rules. Useful for bounded light inspection and deterministic fallback when indexed search is unavailable.
- **Inspect at minimum:**
  - ignore semantics
  - file type filtering
...
- **Why this Execution cares:** Broad language symbol extraction useful for search ranking and lightweight repository profiles. Treat symbol output as derived index evidence.
- **Inspect at minimum:**
...
# CHILD LOOP 1 — TASK 21: Build bounded documentation inspection
...
Implement **Task 21: Build bounded documentation inspection** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build bounded documentation inspection** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
Answer exactly: **HAVE WE ACHIEVED THE FINAL GOAL FOR TASK 21? — YES / PARTIALLY / NO**
...
# CHILD LOOP 2 — TASK 22: Build lexical code sampling with ripgrep for local snapshots
...
Implement **Task 22: Build lexical code sampling with ripgrep for local snapshots** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build lexical code sampling with ripgrep for local snapshots** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
- **BurntSushi/ripgrep** — inspect ignore semantics, file type filtering, regex/search execution, streaming output, performance boundaries.
...
Answer exactly: **HAVE WE ACHIEVED THE FINAL GOAL FOR TASK 22? — YES / PARTIALLY / NO**

Advance only on `YES` with fresh evidence. On an irreducible blocker, stop dependent work and preserve the safest truthful state.

---

# CHILD LOOP 3 — TASK 23: Build symbol sampling with Universal Ctags
...
Implement **Task 23: Build symbol sampling with Universal Ctags** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build symbol sampling with Universal Ctags** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
- **universal-ctags/ctags** — inspect supported language parsers, JSON output, symbol kinds, field selection, incremental/index integration constraints.
...
Answer exactly: **HAVE WE ACHIEVED THE FINAL GOAL FOR TASK 23? — YES / PARTIALLY / NO**
