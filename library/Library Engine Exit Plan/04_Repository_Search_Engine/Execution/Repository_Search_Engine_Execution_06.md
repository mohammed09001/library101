# LIBRARY REPOSITORY SEARCH ENGINE EXECUTION 06 — BUILD LICENSE DETECTION AND UNCERTAINTY STATES + BUILD ACTIVITY AND HEALTH SIGNALS

## Execution Identity

- **Execution:** Library Repository Search Engine Execution 06
- **Roadmap tasks embedded:** 16, 17
...
Deliver one coherent Library Repository Search Engine execution slice covering **Build license detection and uncertainty states + Build activity and health signals**. Each Child Loop must reach `YES`; then perform an integrated review and fresh final-state verification. The Engine must remain backend/terminal-first and game-independent.
...
# CHILD LOOP 1 — TASK 16: Build license detection and uncertainty states
...
Implement **Task 16: Build license detection and uncertainty states** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build license detection and uncertainty states** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
# CHILD LOOP 2 — TASK 17: Build activity and health signals
...
Implement **Task 17: Build activity and health signals** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build activity and health signals** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
