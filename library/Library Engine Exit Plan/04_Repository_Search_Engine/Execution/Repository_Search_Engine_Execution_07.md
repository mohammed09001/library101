# LIBRARY REPOSITORY SEARCH ENGINE EXECUTION 07 — BUILD BOUNDED README INSPECTION + BUILD TOP-LEVEL TREE INSPECTION + BUILD MANIFEST AND DEPENDENCY INSPECTION

## Execution Identity

- **Execution:** Library Repository Search Engine Execution 07
...
Deliver one coherent Library Repository Search Engine execution slice covering **Build bounded README inspection + Build top-level tree inspection + Build manifest and dependency inspection**. Each Child Loop must reach `YES`; then perform an integrated review and fresh final-state verification. The Engine must remain backend/terminal-first and game-independent.
...
# CHILD LOOP 1 — TASK 18: Build bounded README inspection
...
Implement **Task 18: Build bounded README inspection** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build bounded README inspection** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
# CHILD LOOP 2 — TASK 19: Build top-level tree inspection
...
Implement **Task 19: Build top-level tree inspection** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build top-level tree inspection** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
# CHILD LOOP 3 — TASK 20: Build manifest and dependency inspection
...
Implement **Task 20: Build manifest and dependency inspection** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build manifest and dependency inspection** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
