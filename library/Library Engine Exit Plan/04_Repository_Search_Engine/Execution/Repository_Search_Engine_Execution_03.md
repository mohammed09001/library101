# LIBRARY REPOSITORY SEARCH ENGINE EXECUTION 03 — BUILD GITHUB PROVIDER WITH OCTOKIT + BUILD CREDENTIAL AND PERMISSION BROKER INTEGRATION + BUILD GITHUB RATE-LIMIT ACCOUNTING

## Execution Identity

- **Execution:** Library Repository Search Engine Execution 03
- **Roadmap tasks embedded:** 7, 8, 9
- **Roadmap phase:** PHASE II — GITHUB PROVIDER AND QUERY PLANNING
...
Deliver one coherent Library Repository Search Engine execution slice covering **Build GitHub provider with Octokit + Build credential and permission broker integration + Build GitHub rate-limit accounting**. Each Child Loop must reach `YES`; then perform an integrated review and fresh final-state verification. The Engine must remain backend/terminal-first and game-independent.
...
- **Why this Execution cares:** Typed REST/GraphQL access, authentication strategies, GitHub Apps, pagination, retries, throttling, webhooks. Library should hide these behind a RepositoryProvider contract.
- **Inspect at minimum:**
...
# CHILD LOOP 1 — TASK 7: Build GitHub provider with Octokit
...
Implement **Task 7: Build GitHub provider with Octokit** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build GitHub provider with Octokit** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
- **octokit/octokit.js** — inspect REST/GraphQL client composition, auth strategy injection, pagination, retry/throttling plugins, GitHub App support.
...
# CHILD LOOP 2 — TASK 8: Build credential and permission broker integration
...
Implement **Task 8: Build credential and permission broker integration** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build credential and permission broker integration** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
# CHILD LOOP 3 — TASK 9: Build GitHub rate-limit accounting
...
Implement **Task 9: Build GitHub rate-limit accounting** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build GitHub rate-limit accounting** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
