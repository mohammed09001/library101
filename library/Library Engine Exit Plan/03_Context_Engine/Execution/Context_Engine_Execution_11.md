# LIBRARY CONTEXT ENGINE EXECUTION 11 — BUILD CONTEXTPACK HASHING AND CACHE KEYS + BUILD PRECISE INVALIDATION + BUILD REPRODUCIBILITY AND REPLAY

## Execution Identity

- **Execution:** Library Context Engine Execution 11
- **Roadmap tasks embedded:** 26, 27, 28
- **Roadmap phase:** PHASE IV — MODES, CACHING, AND REPRODUCIBILITY
...
Deliver one coherent Library Context Engine execution slice covering **Build ContextPack hashing and cache keys + Build precise invalidation + Build reproducibility and replay**. Each Child Loop must reach `YES`; then perform an integrated review and fresh final-state verification. The Engine must remain backend/terminal-first and game-independent.
...
# CHILD LOOP 1 — TASK 26: Build ContextPack hashing and cache keys
...
Implement **Task 26: Build ContextPack hashing and cache keys** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build ContextPack hashing and cache keys** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
# CHILD LOOP 2 — TASK 27: Build precise invalidation
...
Implement **Task 27: Build precise invalidation** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build precise invalidation** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
# CHILD LOOP 3 — TASK 28: Build reproducibility and replay
...
Implement **Task 28: Build reproducibility and replay** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build reproducibility and replay** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
