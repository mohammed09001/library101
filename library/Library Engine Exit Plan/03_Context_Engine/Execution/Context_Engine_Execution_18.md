# LIBRARY CONTEXT ENGINE EXECUTION 18 — BUILD DETERMINISTIC CONTEXT FIXTURES + BUILD CONTEXT RELEVANCE EVALUATION

## Execution Identity

- **Execution:** Library Context Engine Execution 18
- **Roadmap tasks embedded:** 38, 39
- **Roadmap phase:** PHASE VII — EVALUATION AND V1 GATE
...
Deliver one coherent Library Context Engine execution slice covering **Build deterministic context fixtures + Build Context relevance evaluation**. Each Child Loop must reach `YES`; then perform an integrated review and fresh final-state verification. The Engine must remain backend/terminal-first and game-independent.
...
# CHILD LOOP 1 — TASK 38: Build deterministic context fixtures
...
Implement **Task 38: Build deterministic context fixtures** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build deterministic context fixtures** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
# CHILD LOOP 2 — TASK 39: Build Context relevance evaluation
...
Implement **Task 39: Build Context relevance evaluation** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build Context relevance evaluation** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
