# LIBRARY CONTEXT ENGINE EXECUTION 03 — BUILD PROVIDER REGISTRY AND CAPABILITY PROBING + BUILD MEMORY CONTEXT PROVIDER + BUILD STUDY CONTEXT PROVIDER

## Execution Identity

- **Execution:** Library Context Engine Execution 03
- **Roadmap tasks embedded:** 7, 8, 9
- **Roadmap phase:** PHASE II — PROVIDER LAYER AND CANDIDATE GATHERING
...
Deliver one coherent Library Context Engine execution slice covering **Build provider registry and capability probing + Build Memory Context Provider + Build Study Context Provider**. Each Child Loop must reach `YES`; then perform an integrated review and fresh final-state verification. The Engine must remain backend/terminal-first and game-independent.
...
# CHILD LOOP 1 — TASK 7: Build provider registry and capability probing
...
Implement **Task 7: Build provider registry and capability probing** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build provider registry and capability probing** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
# CHILD LOOP 2 — TASK 8: Build Memory Context Provider
...
Implement **Task 8: Build Memory Context Provider** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build Memory Context Provider** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
# CHILD LOOP 3 — TASK 9: Build Study Context Provider
...
Implement **Task 9: Build Study Context Provider** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build Study Context Provider** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
