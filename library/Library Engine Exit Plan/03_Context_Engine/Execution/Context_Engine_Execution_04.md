# LIBRARY CONTEXT ENGINE EXECUTION 04 — BUILD PERFORMANCE CONTEXT PROVIDER + BUILD REPOSITORY MAP CONTEXT PROVIDER + BUILD PROJECT FILE CONTEXT PROVIDER

## Execution Identity

- **Execution:** Library Context Engine Execution 04
...
Deliver one coherent Library Context Engine execution slice covering **Build Performance Context Provider + Build Repository Map Context Provider + Build Project File Context Provider**. Each Child Loop must reach `YES`; then perform an integrated review and fresh final-state verification. The Engine must remain backend/terminal-first and game-independent.
...
# CHILD LOOP 1 — TASK 10: Build Performance Context Provider
...
Implement **Task 10: Build Performance Context Provider** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build Performance Context Provider** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
# CHILD LOOP 2 — TASK 11: Build Repository Map Context Provider
...
Implement **Task 11: Build Repository Map Context Provider** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build Repository Map Context Provider** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
# CHILD LOOP 3 — TASK 12: Build Project File Context Provider
...
Implement **Task 12: Build Project File Context Provider** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build Project File Context Provider** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
