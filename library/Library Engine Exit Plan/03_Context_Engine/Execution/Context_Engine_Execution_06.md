# LIBRARY CONTEXT ENGINE EXECUTION 06 — BUILD DETERMINISTIC RELEVANCE BASELINE + BUILD REPOSITORY-MAP GRAPH RELEVANCE + BUILD CROSS-PROVIDER DEDUPLICATION

## Execution Identity

- **Execution:** Library Context Engine Execution 06
- **Roadmap tasks embedded:** 15, 16, 17
...
Deliver one coherent Library Context Engine execution slice covering **Build deterministic relevance baseline + Build repository-map graph relevance + Build cross-provider deduplication**. Each Child Loop must reach `YES`; then perform an integrated review and fresh final-state verification. The Engine must remain backend/terminal-first and game-independent.
...
# CHILD LOOP 1 — TASK 15: Build deterministic relevance baseline
...
Implement **Task 15: Build deterministic relevance baseline** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build deterministic relevance baseline** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
# CHILD LOOP 2 — TASK 16: Build repository-map graph relevance
...
Implement **Task 16: Build repository-map graph relevance** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build repository-map graph relevance** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
# CHILD LOOP 3 — TASK 17: Build cross-provider deduplication
...
Implement **Task 17: Build cross-provider deduplication** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build cross-provider deduplication** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
