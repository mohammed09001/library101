# LIBRARY PROJECT PROJECTION ENGINE EXECUTION 02 — DEFINE PROJECTIONMANIFEST + DEFINE GENERATED VS TWO-WAY VS EPHEMERAL MODES + PUBLISH PROJECTION CONTRACTS/EVENTS

## Execution Identity

- **Execution:** Library Project Projection Engine Execution 02
...
Deliver one coherent Library Project Projection Engine execution slice covering **Define ProjectionManifest + Define generated vs two-way vs ephemeral modes + Publish Projection contracts/events**. Each Child Loop must reach `YES`; then perform an integrated review and fresh final-state verification. The Engine must remain backend/terminal-first and game-independent.
...
# CHILD LOOP 1 — TASK 4: Define ProjectionManifest
...
Implement **Task 4: Define ProjectionManifest** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Define ProjectionManifest** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
# CHILD LOOP 2 — TASK 5: Define generated vs two-way vs ephemeral modes
...
Implement **Task 5: Define generated vs two-way vs ephemeral modes** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Define generated vs two-way vs ephemeral modes** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
# CHILD LOOP 3 — TASK 6: Publish Projection contracts/events
...
Implement **Task 6: Publish Projection contracts/events** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Publish Projection contracts/events** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
