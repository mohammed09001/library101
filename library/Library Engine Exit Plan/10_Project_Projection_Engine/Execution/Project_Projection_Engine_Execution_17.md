# LIBRARY PROJECT PROJECTION ENGINE EXECUTION 17 — BUILD CROSS-PLATFORM WATCHER FIXTURES + BUILD PATH/SYMLINK SECURITY QUALIFICATION

## Execution Identity

- **Execution:** Library Project Projection Engine Execution 17
- **Roadmap tasks embedded:** 34, 35
- **Roadmap phase:** PHASE VI — QUALIFICATION AND V1 GATE
...
- **Execution order:** Task 34 → Task 35
...
Deliver one coherent Library Project Projection Engine execution slice covering **Build cross-platform watcher fixtures + Build path/symlink security qualification**. Each Child Loop must reach `YES`; then perform an integrated review and fresh final-state verification. The Engine must remain backend/terminal-first and game-independent.
...
# CHILD LOOP 1 — TASK 34: Build cross-platform watcher fixtures
...
Implement **Task 34: Build cross-platform watcher fixtures** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build cross-platform watcher fixtures** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
# CHILD LOOP 2 — TASK 35: Build path/symlink security qualification
...
Implement **Task 35: Build path/symlink security qualification** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build path/symlink security qualification** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
