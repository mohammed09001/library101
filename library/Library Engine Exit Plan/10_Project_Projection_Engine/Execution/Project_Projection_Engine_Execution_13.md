# LIBRARY PROJECT PROJECTION ENGINE EXECUTION 13 — BUILD PROJECTION REGENERATION/CATCH-UP + BUILD ORPHAN/CLEANUP POLICY + BUILD THE PROJECTION CLI

## Execution Identity

- **Execution:** Library Project Projection Engine Execution 13
- **Roadmap tasks embedded:** 28, 29, 30
- **Roadmap phase:** PHASE V — SYNC, TERMINAL, SECURITY, AND RECOVERY
...
Deliver one coherent Library Project Projection Engine execution slice covering **Build projection regeneration/catch-up + Build orphan/cleanup policy + Build the Projection CLI**. Each Child Loop must reach `YES`; then perform an integrated review and fresh final-state verification. The Engine must remain backend/terminal-first and game-independent.
...
# CHILD LOOP 1 — TASK 28: Build projection regeneration/catch-up
...
Implement **Task 28: Build projection regeneration/catch-up** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build projection regeneration/catch-up** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
# CHILD LOOP 2 — TASK 29: Build orphan/cleanup policy
...
Implement **Task 29: Build orphan/cleanup policy** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build orphan/cleanup policy** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
# CHILD LOOP 3 — TASK 30: Build the Projection CLI
...
Implement **Task 30: Build the Projection CLI** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build the Projection CLI** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
