# LIBRARY PROJECT PROJECTION ENGINE EXECUTION 08 — BUILD EDIT VALIDATION AND SCHEMA CHECKING + BUILD STALE-EDIT/CONFLICT DETECTION + BUILD RENAME/DELETE SEMANTICS FOR EDITABLE FILES

## Execution Identity

- **Execution:** Library Project Projection Engine Execution 08
- **Roadmap tasks embedded:** 17, 18, 19
- **Roadmap phase:** PHASE III — TWO-WAY EDIT INTAKE AND FILE WATCHING
...
Deliver one coherent Library Project Projection Engine execution slice covering **Build edit validation and schema checking + Build stale-edit/conflict detection + Build rename/delete semantics for editable files**. Each Child Loop must reach `YES`; then perform an integrated review and fresh final-state verification. The Engine must remain backend/terminal-first and game-independent.
...
# CHILD LOOP 1 — TASK 17: Build edit validation and schema checking
...
Implement **Task 17: Build edit validation and schema checking** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build edit validation and schema checking** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
# CHILD LOOP 2 — TASK 18: Build stale-edit/conflict detection
...
Implement **Task 18: Build stale-edit/conflict detection** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build stale-edit/conflict detection** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
# CHILD LOOP 3 — TASK 19: Build rename/delete semantics for editable files
...
Implement **Task 19: Build rename/delete semantics for editable files** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build rename/delete semantics for editable files** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
