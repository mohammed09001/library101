# LIBRARY PROJECT PROJECTION ENGINE EXECUTION 09 — BUILD PROJECT METADATA/ANCHOR PROJECTION + BUILD CONTEXTPACK PROJECTIONS + BUILD STUDY PROJECTIONS

## Execution Identity

- **Execution:** Library Project Projection Engine Execution 09
- **Roadmap tasks embedded:** 20, 21, 22
- **Roadmap phase:** PHASE IV — ENGINE-SPECIFIC PROJECTIONS
...
- **Execution order:** Task 20 → Task 21 → Task 22
...
Deliver one coherent Library Project Projection Engine execution slice covering **Build Project metadata/anchor projection + Build ContextPack projections + Build Study projections**. Each Child Loop must reach `YES`; then perform an integrated review and fresh final-state verification. The Engine must remain backend/terminal-first and game-independent.
...
# CHILD LOOP 1 — TASK 20: Build Project metadata/anchor projection
...
Implement **Task 20: Build Project metadata/anchor projection** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build Project metadata/anchor projection** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
# CHILD LOOP 2 — TASK 21: Build ContextPack projections
...
Implement **Task 21: Build ContextPack projections** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build ContextPack projections** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
# CHILD LOOP 3 — TASK 22: Build Study projections
...
Implement **Task 22: Build Study projections** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build Study projections** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
