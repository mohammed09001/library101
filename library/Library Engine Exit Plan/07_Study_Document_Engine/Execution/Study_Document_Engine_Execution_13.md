# LIBRARY STUDY / DOCUMENT ENGINE EXECUTION 13 — BUILD THE STUDY CLI + EXPOSE STUDY READ TOOLS OVER MCP/HOST-NATIVE INTERFACES + BUILD CONTENT SANITIZATION

## Execution Identity

- **Execution:** Library Study / Document Engine Execution 13
- **Roadmap tasks embedded:** 26, 27, 28
- **Roadmap phase:** PHASE V — TERMINAL, SECURITY, AND OPERATIONS
...
Deliver one coherent Library Study / Document Engine execution slice covering **Build the Study CLI + Expose Study read tools over MCP/host-native interfaces + Build content sanitization**. Each Child Loop must reach `YES`; then perform an integrated review and fresh final-state verification. The Engine must remain backend/terminal-first and game-independent.
...
- **Why this Execution cares:** Expose tools/resources/prompts through a standard agent-facing protocol. The 2026-07-28 MCP line uses a stateless protocol core and updated routing/auth semantics; verify the current SDK/spec during execution rather than coding against stale examples.
- **Inspect at minimum:**
...
# CHILD LOOP 1 — TASK 26: Build the Study CLI
...
Implement **Task 26: Build the Study CLI** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build the Study CLI** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
Answer exactly: **HAVE WE ACHIEVED THE FINAL GOAL FOR TASK 26? — YES / PARTIALLY / NO**
...
# CHILD LOOP 2 — TASK 27: Expose Study read tools over MCP/host-native interfaces
...
Implement **Task 27: Expose Study read tools over MCP/host-native interfaces** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Expose Study read tools over MCP/host-native interfaces** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
- **modelcontextprotocol/typescript-sdk** — inspect server/client package split, tool schemas, stdio transport, Streamable HTTP, authorization helpers.
...
Answer exactly: **HAVE WE ACHIEVED THE FINAL GOAL FOR TASK 27? — YES / PARTIALLY / NO**

Advance only on `YES` with fresh evidence. On an irreducible blocker, stop dependent work and preserve the safest truthful state.

---

# CHILD LOOP 3 — TASK 28: Build content sanitization
...
Implement **Task 28: Build content sanitization** as a coherent repository-native capability, adapting details to verified current architecture while preserving the embedded functional intent.

## Final Goal for This Child Loop

An independent reviewer can inspect the final repository and fresh evidence and conclude that **Build content sanitization** is implemented through canonical owners, verified under relevant failure/boundary conditions, and does not leave unjustified duplicate architecture.
...
Answer exactly: **HAVE WE ACHIEVED THE FINAL GOAL FOR TASK 28? — YES / PARTIALLY / NO**
